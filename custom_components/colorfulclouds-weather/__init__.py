...
https://github.com/shiqixixixi/colorfulclouds-weather
"""
import asyncio
import requests
import json
...
async def async_setup(hass: HomeAssistant, config: Config) -> bool:
    """Set up configured colorfulclouds-weather."""
    hass.data.setdefault(DOMAIN, {})
    return True

async def async_setup_entry(hass, config_entry) -> bool:
    
    # hass.http.register_static_path(ROOT_PATH, hass.config.path('custom_components/colorfulclouds-weather/local'), False)
    # _LOGGER.debug(f"register_static_path: {ROOT_PATH + ':custom_components/colorfulclouds-weather/local'}")
    # hass.components.frontend.add_extra_js_url(hass, ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card.js?ver='+VERSION)
    # _LOGGER.debug(f"Add extra JS module: {ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card.js?ver='+VERSION}")
    # hass.components.frontend.add_extra_js_url(hass, ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card-chart.js?ver='+VERSION)
    # _LOGGER.debug(f"Add extra JS module: {ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card-chart.js?ver='+VERSION}")
    # hass.components.frontend.add_extra_js_url(hass, ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card-more.js?ver='+VERSION)
    # _LOGGER.debug(f"Add extra JS module: {ROOT_PATH + '/lovelace-colorfulclouds-weather-card/lovelace-colorfulclouds-weather-card-more.js?ver='+VERSION}")
    # _LOGGER.info("setup platform weather.colorfulclouds-weather...")
    
    """Set up colorfulclouds-weather as config entry."""
