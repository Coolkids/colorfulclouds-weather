...
class WeatherCard extends LitElement {
  ...
  static getStubConfig() {
	return {entity: 'weather.wo_de_jia',
			houer_forecast: true,
			show_forecast: true,
			icon: '/colorfulclouds-weather-local/lovelace-colorfulclouds-weather-card/weathericons/'
			};
  }
  ...
  render() {
	...
	const iconUrl = this._config.icon || '/colorfulclouds-weather-local/lovelace-colorfulclouds-weather-card/weathericons/';
